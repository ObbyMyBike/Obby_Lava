...
public class MotionSolver
{
    ...
    public MotionSolver(CharacterController controller, float moveSpeed, float jumpForce, float gravity, float dashDistance, float dashDuration, float dashCooldown)
    {
