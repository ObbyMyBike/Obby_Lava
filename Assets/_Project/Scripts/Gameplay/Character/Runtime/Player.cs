...
public class Player : MonoBehaviour, IMoveDirectionProvider
{
    ...
    private MotionSolver _movement;
    ...
    private void Awake()
    {
        ...
        _movement = new MotionSolver(_controller, _dataConfig.MoveSpeed, _dataConfig.JumpForce, _dataConfig.Gravity, _dataConfig.DashDistance, _dataConfig.DashDuration, _dataConfig.DashCooldown);
        ...
        _rotator = new Rotator(transform, _dataConfig.RotationSpeed);
